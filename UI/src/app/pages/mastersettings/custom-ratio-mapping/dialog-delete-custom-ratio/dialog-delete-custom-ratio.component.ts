...
@Component({
  selector: 'ngx-dialog-delete-custom-ratio',
  templateUrl: './dialog-delete-custom-ratio.component.html',
  styleUrls: ['./dialog-delete-custom-ratio.component.scss']
})
export class DialogDeleteCustomRatioComponent implements OnInit {
  ...
  mappingId:number;
  jsondata: any;
  constructor(protected ref: NbDialogRef<DialogDeleteCustomRatioComponent>,
  ...
  confirmDelete(){
    ...
    this.customSWRatioService.deleteCustomRatio(this.jsondata).pipe(
