...
import { DialogDeleteBomStageMappingComponent } from './dialog-delete-bom-stage-mapping/dialog-delete-bom-stage-mapping.component';
...
export class ButtonDeleteRenderComponent implements OnInit {
  ...
  deleteMapping(): void {
    this.dialogService.open(DialogDeleteBomStageMappingComponent, {
